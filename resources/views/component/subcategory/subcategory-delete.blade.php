        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    ...
                    <button onclick="DeleteSubcategory()" type="button" id="confirmDelete" class="btn bg-gradient-danger" >Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    async function DeleteSubcategory()
    {
        ...
        let response = await axios.post('/subcategory-delete',{
            id:id
        })
