...
<script>
    async function FillUpdatedForm(id)
    {
        ...
        document.getElementById('categoryDescriptionUpdate').value = response.data.data['description']
    ...
    async function  Update()
    {
        ...
        let categoryDesc    = document.getElementById('categoryDescriptionUpdate').value
        ...
        else
        {
            ...
            let response = await axios.post('/category-update',{
                name:categoryName,
