                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="px-3 row px-xl-5 px-sm-4">
                            <div class="px-1 col-3 ms-auto">
                                <a class="py-1 btn btn-outline-light w-100" href="javascript:;">
                        ...
                        <p class="my-1 text-center lh-base">Or sign in with credentials</p>
                        <div class="px-4 card-body">
                            <div class="mb-3">
                                <input type="text" id="login" class="form-control" name="email"
                                    placeholder="Email" :value="old('login')" aria-label="Email">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="form-check form-switch d-flex">
                                ...
                                <label class="mb-0 form-check-label ms-2" for="rememberMe">Remember me</label>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="mt-2 mb-4 btn btn-white w-100">Sign up</button>
                            </div>

                            <div class="flex items-center mt-4 justify-content-end">
